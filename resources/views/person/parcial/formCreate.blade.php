...
<div class="form-group">
	...
	{!! Form::select('obrasocial',\cud\Obrasocial::orderBy('id')->pluck('nombre','id'),null,['class'=>'form-control']) !!}
</div>

<div class="form-group">
	{!! Form::label('estudio', 'Estudio') !!}
	{!! Form::select('estudio', \cud\Estudio::orderBy('id')->pluck('nombre','id') ,null,['class' => 'form-control']) !!}
</div>

<div class="form-group">
	{!! Form::label('trabajo', 'Trabajo') !!}
	{!! Form::select('trabajo', \cud\Trabajo::orderBy('id')->pluck('nombre','id') ,null,['class' => 'form-control']) !!}
</div>
